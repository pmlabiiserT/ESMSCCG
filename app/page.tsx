...
import InteractiveScienceBackground from "./components/InteractiveScienceBackground";
...
export default function Home() {
  ...
  <InteractiveScienceBackground />

  <div className="fixed inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/30 z-[2] pointer-events-none" />
