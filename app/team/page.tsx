...
export default function TeamPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#050816] via-[#081c34] to-[#0d2d52] text-white">
      ...
      <section className="relative z-10 lg:min-h-screen px-8 pt-48 pb-24">
...
{/* Goal Boxes */}
            ...
            <a
              href="#phd2"
              className="absolute top-[16%] left-1/2 -translate-x-1/2 flex flex-col items-center group"
            >
            ...
            <a
              href="#phd3"
              className="absolute top-[27%] left-[19%] flex flex-col items-center group"
            >
            ...
            <a
              href="#phd4"
              className="absolute top-[27%] right-[19%] flex flex-col items-center group"
            >
...
{/* DEFENDERS */}
            ...
            >
              ...
              <Image
                src="/ESMSCCG/photos/team/f_sulekha.jpeg"
                alt="member"
                width={90}
                height={90}
                className="rounded-full border-4 border-cyan-400 shadow-[0_0_30px_rgba(34,211,238,0.9)] group-hover:scale-110 transition duration-300 animate-pulse object-cover"
          ...
          <div className="space-y-6 text-2xl text-gray-300 leading-relaxed">
            ...
            <p>
              <span className="text-lime-400 font-semibold drop-shadow-[0_0_10px_rgba(196,181,253,0.5)]">
               ...
               Numismatist, Philatelist, Traveller. Food-Football-Photography.
            </p>
...
{/* ================================================= */}
      ...
      >
        ...
        <div className="flex justify-center order-1 lg:order-2">
          ...
          <Image
            src="/ESMSCCG/photos/team/sulekha.jpeg"
            alt="member"
            width={420}
            height={420}
            className="rounded-[35px] border border-cyan-400/20 shadow-[0_0_45px_rgba(34,211,238,0.25)] object-cover"
      ...
      <div className="space-y-6 text-2xl text-gray-300 leading-relaxed">
        ...
        <p>
          ...
          <span className="italic">
            Photophysics and Photochemistry of Indolic Compounds: Effect of Electronic Substitution and Nonadiabatic Coupling
          </span>
        </p>
        ...
        <p>
          ...
          Post-Doctoral fellow at Indian Association For The Cultivation Of Science (IACS), Kolkata
        </p>
