...
import MultiScaleField from "./components/MultiScaleField";


export default function ResearchPage() {
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-[#030712] via-[#07111f] to-[#030712] text-white px-6 pt-40 pb-24">
    ...
    <div className="text-6xl animate-bounce drop-shadow-[0_0_18px_rgba(34,211,238,0.75)]">
      ...
      <section className="max-w-7xl mx-auto lg:min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
        ...
        <div className="relative">
          ...
          <Image
            src="/ESMSCCG/photos/research/1_white_1.png"
            alt="Research Topic"
            width={700}
            height={500}
      ...
      <section className="max-w-7xl mx-auto lg:min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
        ...
        <div className="relative">
          ...
          <Image
            src="/ESMSCCG/photos/research/2_white_1.png"
            alt="Research Topic"
            width={700}
            height={500}
            className="relative rounded-3xl object-cover shadow-[0_0_18px_rgba(34,211,238,0.25)]"
      ...
      <section className="max-w-7xl mx-auto lg:min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="relative">
          ...
          <Image
            src="/ESMSCCG/photos/research/4_white_1.png"
            alt="Research Topic"
            width={700}
            height={500}
            className="relative rounded-3xl object-cover shadow-[0_0_18px_rgba(34,211,238,0.25)]"
